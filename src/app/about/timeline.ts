export const timeline = [
  {
    title:"Childhood",
    year: "Pre-2010 ",
    des: "I grew up with my mom, dad, and brother in the same house in a small, quiet suburb in the deep south of Cape Town, South Africa. We never moved, and my childhood was filled with simple joys. Living close to many beaches, I have fond memories of summers spent swimming and eating ice cream with my mom.\n\nI remember being fascinated by numbers and gadgets. The excitement of counting to 100 for the first time and running to tell my mom, or asking my dad what \"a billion times a billion\" is.",
    pics: [
      // {
      //   "name": "pre2010a.jpg",
      //   "width": 604,
  ...
  },
  {
    title:"High School",
    year: "2010–2015",
    des: 'Around Grade 9, I developed a deep interest in Maths. I loved drawing graphs and understanding fractions. By the end of high school, double Maths days were my favorite.\n\nDownhill skating was a big passion. Spending every day after school skating and socializing with other skaters on the hill led to strong friendships that have lasted into adulthood. It was common to name your skate crew after the suburb where you skated most. Ours was CFR (Capri FreeRiders), and eventually, most of the crew proudly got CFR tattoos',
    pics: [
      {
        name: "/2015a.jpg",
        width: 2048,
  ...
  },
  {
    title:"First Year",
    year: "2016",
    des: 'At the University of Cape Town, I continued feeding my curiosity for Maths and Physics. I needed to fill a fourth course, and I remember my dad saying that "computers are the way forward." I attended a talk promoting the first-year Computer Science course, and it intrigued me, so I signed up.\n\n Solving my first homework assignment - writing a simple algorithm to calculate the perimeter of a house which involved understanding variables and user input, was so satisfying and got me hooked. I even showed it to my mom and tried to explain it to her!',
    pics: [
      {
        name: "/2016a.jpg",
        width: 2048,
  ...
  {
    title:"Second Year and Vietnam",
    year: "2017",
    des: "In my second year, Computer Science and Maths were still my passions, and I enjoyed learning every day. I especially remember being excited about learning Java objects and preparing for lectures by doing my own research. \n\nThis was also the year I traveled outside South Africa for the first time, visiting my brother in Vietnam. The bustling streets filled with scooters and the unique flow of traffic fascinated me, as did trying the local cuisine.",
    pics: [
      {
        name: "/2017a.jpg",
        width: 1440,
  ...
  {
    title:"Honors and First Relationship",
    year: "2020",
    des: "After a year of playing music and traveling, I felt fulfilled, having accomplished something unique and grown personally. I was ready to return to studying Computer Science. Living close to campus, I joined a couple of societies—Choir and the Japanese Club. This was the university experience I had longed for but had missed in my first three years.\n\nIn the middle of the year, during peak Covid lockdown, I met my first girlfriend through a dating app. Balancing my studies while having to learn new things about myself through the relationship was a lot, though I look back at traveling around South Africa with her and our friends fondly.",
    pics: [
      {
        name: "/2020a.jpg",
        width: 960,
  ...
  },
  {
    title:"Break",
    year: "2024",
    des: "I started the year living in Kommetjie, another coastal suburb near my family home. It was quieter and slower than Muizenberg. \n\n I resigned from my job after three years and am taking an extended break. Initially I wanted to go straight into traveling, but ended up enjoying taking it slow and enjoyed continuing to make my own apps. I launched my first consumer-ready software product, bnbnotifier.com, complete with user accounts, a software service, and payment integration. The app notifies you when a new Airbnb listing is available an area searched for.\n\n The app after that - an efficient spending tracker app - I created a pamphlet and survey to gather user feedback, a rewarding exercise that tested my sales and people skills.",
    pics: [
      {
        name: "/2024a.jpg",
        width: 1204,
